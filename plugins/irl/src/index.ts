...
commands.push(registerCommand({
    ...
    execute: async (args, ctx) => {
        try {
            ...
            let response = await fetch(`https://www.reddit.com/r/gonewild/${sort}.json?limit=100`).then(res => res.json());
            ...
            if (nsfw) { response = await fetch(`https://www.reddit.com/r/gonewild/${sort}.json?limit=100`).then(res => res.json()); }
